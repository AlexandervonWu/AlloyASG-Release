...
public class ComparabilityCaseStudy {
    ...
    public static void main(String[] args) throws ScopeNotFoundException, UnsupportedConstantException {
        ...
        Pair<Triple<Integer, Integer, Integer>, String> visualPair = VisualAPI.getVisual(adjacency1C, adjacency2C, signaturesC, "Compare");
        System.out.println(visualPair.b);
        System.out.println("-----------------------------------------------");
        System.out.println("Copy the command above and run it in the terminal to visualize the graph.");
        ...
        System.out.println("Statistics of the metrics of the comparability: ");
        int numberG1Only = visualPair.a.x;
        int numberG2Only = visualPair.a.y;
